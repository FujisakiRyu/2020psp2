...
- 手元で藤崎くんのコードをコンパイルしてみたけど，上のような入出力結果になりません．
  while文に入る前に，`i=0;`をしないといけません．この初期化をしたら答えが合いました．
- 変数名が謎です．名前を見て何なのかわかるような名前にしてください．ave3とかave2とか謎です．

[comment #20200811 sonoda]
- 変数名が謎です．名前を見て何なのかわかるような名前にしてください．ave3とかave2とか謎です．
- とりあへずOKとしますが，変数の名前は工夫してください．